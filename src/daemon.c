...
/**
 * To prepare reports, report type is either INTERVAL or FINAL.
 *
 * The daemon reports the test data and results according to the time duration
 * for reporting interval. The daemon maintains all its data in its flow
